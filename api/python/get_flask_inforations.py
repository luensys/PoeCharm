...
query_base = {"query":{"status":{"option":"online"},"stats":[{"type":"and","filters":[],"disabled":False}],"filters":{"type_filters":{"filters":{"rarity":{"option":"magic"}},"disabled":False},"trade_filters":{"filters":{"price":{"min":20}},"disabled":False}}},"sort":{"price":"asc"}}
